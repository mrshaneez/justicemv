...
const CasesPage = ({ cases, setCases, viewCase, setViewCase, updateCase, setModal }) => {
  ...
  if (cs) return <CaseDetail cs={cs} updateCase={updateCase} setViewCase={setViewCase} setModal={setModal} activeTab={activeTab} setActiveTab={setActiveTab} canDelete={canDelete} deleteCase={deleteCase} />;
...
const CaseDetail = ({ cs, updateCase, setViewCase, setModal, activeTab, setActiveTab, canDelete, deleteCase }) => {
