    ...
    <div style={{ display: "flex", height: "100vh", overflow: "hidden", background: "var(--paper-2)" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", background: "var(--paper)" }}>
        ...
        <main style={{ flex: 1, overflowY: "auto", padding: "24px 28px", background: "var(--paper-2)" }}>
          ...
          {page === "documents" && <DocumentsPage templates={templates} cases={cases} generatedDocs={generatedDocs} setGeneratedDocs={setGeneratedDocs} setModal={setModal}/>}
      ...
      {modal?.type === "editCase" && <EditCaseModal caseData={modal.caseData} setCases={setCases} judges={judges} lawyers={lawyers} parties={parties} representatives={representatives} onClose={() => setModal(null)}/>}
      {modal === "newTarget" && <NewTargetModal targets={targets} setTargets={setTargets} onClose={() => setModal(null)}/>}
      {modal?.type === "editTarget" && <EditTargetModal target={modal.target} setTargets={setTargets} onClose={() => setModal(null)}/>}
